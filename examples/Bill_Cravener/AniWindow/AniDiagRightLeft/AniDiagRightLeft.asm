...
AniWindow proc hWin:DWORD,uMsg:DWORD,aParam:DWORD,bParam:DWORD
        ...
        .if uMsg == WM_INITDIALOG
                    invoke AnimateWindow,hWin,400,AW_ACTIVATE or AW_HOR_NEGATIVE or AW_VER_POSITIVE
                    invoke SetFocus,hWin
    
        .elseif uMsg == WM_COMMAND

        .elseif uMsg == WM_CLOSE
                    invoke AnimateWindow,hWin,400,AW_HIDE or AW_HOR_NEGATIVE or AW_VER_POSITIVE
