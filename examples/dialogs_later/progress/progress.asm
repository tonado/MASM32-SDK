...
main proc
  ...
  ; -----------------------------------------------------
    ...
    sas [esi+4], " Progress Bar"                        ; macro to assign a string to a pointer
    sas [esi+8], "Click Test Me"                        ; macro to assign a string to a pointer
    pop esi
...
create_dialog proc iinstance:DWORD,extra:DWORD
  ...
  ; -----------------------------------------------------------------------
    ...
    DlgProgress PBS_SMOOTH,10,80,160,10,102
...
DlgProc proc hWin:DWORD,uMsg:DWORD,wParam:DWORD,lParam:DWORD 
    ...
    Switch uMsg
      ...
      ; ----------------------------
        ...
        mov hProgress, rv(GetDlgItem,hWin,102)
      ...
      Case WM_COMMAND
        Switch wParam
          Case IDOK
            ...
            invoke SendMessage,hProgress,PBM_SETRANGE,0,ebx

          lbl0:
            invoke SendMessage,hProgress,PBM_SETPOS,esi,0
            invoke SleepEx,10,0
            add esi, 1
            cmp esi, 200
            jb lbl0
